...
BOT_TOKEN = environ.get('BOT_TOKEN', "7054798623:AAFCtmEJcTi_Z4hjEyT1QwnrFqh9sOibnY8")
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002050862981') # request channel id ( make sure bot is admin )
