...
BOT_TOKEN = environ.get('BOT_TOKEN', "7054798623:AAGipzv0L3AKSYWaceTmRPRh92FAUGwGjbk")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002144894787').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://deendayaldhaked50:uyYGb6Knzh7wCgib@cluster0.hk3ktbf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
