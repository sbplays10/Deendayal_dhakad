...
from database.users_chats_db import db, referal_add_user, get_referal_all_users, get_referal_users_count, get_seconds, delete_all_referal_users
from info import CHANNELS, ADMINS, AUTH_CHANNEL, REFERAL_COUNT, REFERAL_PREMEIUM_TIME, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, SUPPORT_CHAT, MAX_B_TN, VERIFY, HOW_TO_VERIFY, SHORTLINK_API, SHORTLINK_URL, TUTORIAL, IS_TUTORIAL, PREMIUM_USER, PICS, SUBSCRIPTION
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Hey {message.from_user.mention}, ‼️ ʏᴏᴜ ᴀʀᴇ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴠᴇʀɪꜰɪᴇᴅ !\nɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ꜰᴏʀ 𝟼 Hᴏᴜʀs.\n\nYᴏᴜ ɢᴏ ʙᴀᴄᴋ ᴛᴏ ᴛʜᴇ Gʀᴏᴜᴘ ᴀɴᴅ sᴇᴀʀᴄʜ ʏᴏᴜʀ ғᴀᴠᴏʀɪᴛᴇ ᴍᴏᴠɪᴇ ᴀɢᴀɪɴ ᴀɴᴅ ɢᴇᴛ ᴅɪʀᴇᴄᴛ ᴍᴏᴠɪᴇ ғɪʟᴇs ғᴏʀ 𝟼 ʜᴏᴜʀs.\n\n\n⚜️आप सफलतापूर्वक सत्यापित हो गए हैं अब आप 𝟼 घंटे तक Dɪʀᴇᴄᴛ ᴍᴏᴠɪᴇ की ғɪʟᴇs प्राप्त कर सकते हैं\n\nआप वापस Gʀᴏᴜᴘ पर जाएं और फिर से अपनी मनपसंद ᴍᴏᴠɪᴇ sᴇᴀʀᴄʜ करें और 𝟼 घंटे तक Dɪʀᴇᴄᴛ ᴍᴏᴠɪᴇ ғɪʟᴇs प्राप्त करें।</b>",
                protect_content=False
            )
