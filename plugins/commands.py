...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        await asyncio.sleep(0.4)
        await m.delete()        
        m=await message.reply_sticker("CAACAgEAAxkBAAJ59Waifb3IY_0tjvDY5RXzJLda3-HyAAIDBwAC0gG5RQG_d6AESDArHgQ") 
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            ...
            await message.reply_photo(
                ...
                caption=f"<b>Hey {message.from_user.mention},\n\n𝑌𝑜𝑢 𝐴𝑟𝑒 𝑆𝑢𝑐𝑐𝑒𝑠𝑠𝑓𝑢𝑙 𝑉𝑒𝑟𝑖𝑓𝑖𝑒𝑑 ! 𝑁𝑜𝑤 𝑌𝑜𝑢 𝐻𝑎𝑣𝑒 𝑈𝑛𝑙𝑖𝑚𝑖𝑡𝑒𝑑 𝐴𝑐𝑐𝑒𝑠𝑠 𝐹𝑜𝑟 20 𝐻𝑜𝑢𝑟𝑠.\n\n<blockquote>आप सफलतापूर्वक सत्यापित हो गए हैं अब आप 20 घंटे तक 𝐷𝑖𝑟𝑒𝑐𝑡 𝑀𝑜𝑣𝑖𝑒 की 𝐹𝑖𝑙𝑒𝑠 प्राप्त कर सकते हैं।</blockquote></b>",
                reply_markup=InlineKeyboardMarkup(btn)
            )
