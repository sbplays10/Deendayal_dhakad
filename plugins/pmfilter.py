...
async def advantage_spell_chok(client, name, msg, reply_msg, ai_search):
    ...
    try:
        ...
        k = await msg.reply_photo(photo=SPELL_IMG, caption=script.I_CUDNT.format(mv_rqst), reply_markup=InlineKeyboardMarkup(button))
    ...
    if AI_SPELL_CHECK == True and ai_search == True:
        ai_search_new = False
        await reply_msg.edit_text("<b>⚡𝘼𝘾𝙏𝙄𝙑𝙀 𝘼𝘿𝙑𝘼𝙉𝘾𝙀 𝙎𝙋𝙀𝙇𝙇 𝘾𝙃𝙀𝘾𝙆⚡</b>")
