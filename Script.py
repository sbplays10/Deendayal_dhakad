...
🥰 Yᴏᴜ ᴄᴀɴ ʀᴇǫᴜᴇsᴛ ᴍᴏᴠɪᴇs ᴡʜɪᴄʜ ᴀʀᴇ ɴᴏᴛ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʟɪᴋᴇ ᴛʜɪs👇

 /Rᴇǫᴜᴇsᴛ {Cᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ᴏғ ᴛʜᴇ ᴍᴏᴠɪᴇ & Rᴇʟᴇᴀsᴇ ʏᴇᴀʀ}

Exᴀᴍᴘʟᴇ - /Rᴇǫᴜᴇsᴛ Jᴀᴡᴀɴ 𝟸𝟶𝟸𝟹

/Rᴇǫᴜᴇsᴛ Fɪɢʜᴛᴇʀ 𝟸𝟶𝟸𝟺 </b>"""
...
"""
 ...
 <b>ᴄᴏᴍᴍᴀɴᴅ<b> :<b> /ᴠɪᴅᴇᴏ ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏ ʟɪɴᴋ<b>"""
